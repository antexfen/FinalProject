package com.skillspeed.application;
...
import com.skillspeed.dao.EventDao;
import com.skillspeed.daoImpl.EventDaoImpl;
import com.skillspeed.util.Utility;

public class EventRegistrationApp {

	SessionFactory sessionFactory;
	private final static Logger LOG = Logger.getLogger(EventRegistrationApp.class.getName());
	...
	public static void main(String[] args) {
		...
		EventRegistrationApp eventMain = new EventRegistrationApp();
		eventMain.setup();
